                    ...
                    @if($datos)
                        ...
                        <tr>
                          ...
                          <td><button class="btn-warning" data-toggle='modal' data-target='#formEditar'
                                        ...
                                        data-ap="{{$val->descripcion}}" data-na="{{$val->tipo}}"
                                        data-dir="{{$val->presio}}">
                            ...
                            <td>
                                <form method="POST" action="{{route('productos.destroy',$val->id)}}">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="input-group mb-3">
                            ...
                            <input required type="text" class="form-control" placeholder="Descripcion" id="descripcion" name="descripcion">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-group mb-3">
                            ...
                            <input required type="text" class="form-control" placeholder="Tipo" id="tipo" name="tipo">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group mb-3">
                            ...
                            <input required type="text" class="form-control" placeholder="Precio" id="precio" name="precio">
                        </div>
                    </div>
                </div>
              <div class="row">
            ...
            <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="input-group mb-3">
                            ...
                            <input required type="text" class="form-control" placeholder="Descripcion" id="eapellido" name="eapellido">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-group mb-3">
                            ...
                            <input required type="text" class="form-control" placeholder="Tipo" id="eedad" name="eedad">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="input-group mb-3">
                            ...
                            <input required type="text" class="form-control" placeholder="Precio" id="edom" name="edom">
                        </div>
                    </div>
                </div>
              <div class="row">
...
<script>
    function mostrarDatos(btn){
        ...
        var url="{{route('productos.update',0)}}";
